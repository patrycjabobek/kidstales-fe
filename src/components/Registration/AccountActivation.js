...
import {MainTitle} from "../../styledHelpers/Components";
...
export default function AccountActivation(props) {
    ...
    return (
        <ActivationBox>
            <StyledTitle>Wysłano link aktywacyjny!</StyledTitle>
            <div>
                <StyledParagraph>Na twój adres mailowy <StyledSpan>{email}</StyledSpan> <br/>wysłaliśmy wiadomość z linkiem aktywacyjnym.
